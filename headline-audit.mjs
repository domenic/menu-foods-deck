...
const proposals = new Map([
  ...
  ["mortadella", { core: "Pig; mild, cooked sausage." }],
  ["prosciutto", { core: "Pig; dry-cured ham.", context: "usually thinly sliced; Italian; usually means crudo on English menus" }],
  ...
  ["bresaola", { core: "Cow; air-dried, salted beef.", context: "usually thinly sliced" }],
  ...
  ["saucisson", { core: "Usually pig; dry-cured sausage.", context: "usually thick; French" }],
  ...
  ["pâté", { core: "Animal varies; meat paste; often liver." }],
  ...
  ["jamón ibérico", { core: "Iberian pig; dry-cured ham.", context: "Spanish" }],
  ...
  ["filet mignon", { core: "Cow; tenderloin steak; very tender.", context: "usually small" }],
  ...
  ["scamorza", { core: "Semi-soft, stretched-curd cheese; often smoked.", context: "traditionally pear-shaped" }],
  ["stracchino", { core: "Soft, mild, creamy cheese.", context: "Italian; cow’s milk" }],
  ["taleggio", { core: "Soft, mild cheese.", context: "strong-smelling; washed-rind; Italian; cow’s milk" }],
  ...
  ["brie", { core: "Soft, creamy cheese.", context: "bloomy-rind; French; cow’s milk" }],
  ["brillat-savarin", { core: "Very rich, soft, triple-cream cheese.", context: "French" }],
  ["camembert", { core: "Soft, earthy cheese.", context: "bloomy-rind; French; cow’s milk" }],
  ...
  ["époisses", { core: "Soft, pungent cheese.", context: "washed-rind; French; cow’s milk" }],
  ...
  ["munster", { core: "Soft, pungent cheese.", context: "washed-rind; French; cow’s milk" }],
  ["neufchâtel", { core: "Soft, slightly crumbly cheese.", context: "bloomy-rind; French; cow’s milk" }],
  ["ossau-iraty", { core: "Firm, nutty cheese.", context: "sheep’s milk; French Basque" }],
  ["pont-l’évêque", { core: "Soft, pungent cheese.", context: "washed-rind; French; cow’s milk" }],
  ...
  ["roquefort", { core: "Tangy blue cheese.", context: "sheep’s milk; French" }],
  ...
  ["tomme", { core: "Rustic cheese family; not one specific style.", context: "typically round; French/Swiss term" }],
  ["triple crème", { core: "Very rich, soft cheese with extra cream added." }],
  ["valençay", { core: "Soft, ash-coated, pyramid-shaped cheese.", context: "goat’s milk; French" }],
  ...
  ["manchego", { core: "Firm cheese.", context: "sheep’s milk; Spanish" }],
  ...
  ["puntarelle", { core: "Crisp, slightly bitter chicory shoots.", context: "from Catalonian chicory" }],
  ["cavolo nero", { core: "Dark leafy cabbage; Italian kale.", context: "Tuscan" }],
...
const pastaContext = new Map([
  ...
  ["fileja", "Calabrian"],
  ["fregola", "Sardinian"],
  ["garganelli", "egg pasta"],
  ["malloreddus", "Sardinian"],
  ["pastina", "usually for soup"],
  ["pici", "Tuscan"],
...
const pastaCoreOverrides = new Map([
  ...
  ["garganelli", "Ridged pasta tubes with a visible seam."],
  ["malloreddus", "Small ridged pasta shells."],
  ["pastina", "Any very small pasta."],
  ["pici", "Thick, hand-rolled spaghetti."],
  ["scialatielli", "Short, thick, flat ribbons."],
  ["tagliatelle", "Long, flat pasta ribbons."],
  ["tagliolini", "Very narrow, flat pasta ribbons."],
  ["trofie", "Short, thin, hand-twisted pasta."],
  ["ziti", "Long, smooth pasta tubes."],
]);

const auditNotes = new Map([
  ["mortadella", "Drops whole-sausage size because it does not describe the serving on the plate."],
  ["prosciutto", "Moves the usual thin slicing to context and preserves the English-menu default there."],
  ...
  ["bresaola", "Moves the usual thin slicing from the recognition cue to context."],
  ...
  ["saucisson", "Moves whole-sausage thickness to context."],
  ["pâté", "Drops the generic adjective “seasoned” while retaining its form and common liver content."],
  ["jamón ibérico", "Drops the subjective marketing adjective “premium”."],
  ["filet mignon", "Moves usual portion size to context while retaining tenderness in the recognition cue."],
  ...
  ["garganelli", "Moves dough type to context so the recognition cue concentrates on visible shape."],
  ["pastina", "Moves its usual soup use to context so the recognition cue concentrates on size."],
  ["tagliatelle", "Moves dough type to context so the recognition cue concentrates on visible shape."],
  ["tagliolini", "Moves dough type to context so the recognition cue concentrates on visible shape."],
  ...
  ["scamorza", "Moves whole-cheese shape to context because it does not describe the serving on the plate."],
  ["taleggio", "Uses the source’s useful contrast between mild flavor and strong smell, with rind style in context."],
  ["brie", "Moves rind style to context while retaining immediately useful texture."],
  ["camembert", "Moves rind style to context while retaining immediately useful texture and flavor."],
  ["époisses", "Moves rind style to context and keeps the standardized “pungent” intensity cue."],
  ["munster", "Moves rind style to context and keeps the standardized “pungent” intensity cue."],
  ["neufchâtel", "Replaces rind jargon in the recognition cue with its useful slightly crumbly texture."],
  ["ossau-iraty", "Moves milk type to context while retaining texture and flavor."],
  ["pont-l’évêque", "Replaces vague “aromatic” with standardized “pungent” and moves rind style to context."],
  ["roquefort", "Moves milk type to context while retaining its tangy blue identity."],
  ["tomme", "Makes explicit that this is a family rather than one style and moves whole-cheese shape to context."],
  ["valençay", "Moves milk type to context while retaining its distinctive coating and shape."],
  ["feta", "Moves its usual milk type to context so the bold cue contains only immediately useful texture and preparation facts."],
  ["manchego", "Moves milk type to context so firmness is the graded cue."],
  ["puntarelle", "Moves the source chicory variety to context while retaining eating texture and flavor."],
  ["cavolo nero", "Moves Tuscan identity to context while retaining plain-English food identity."],
]);
